...
var overscrollDeltaY = 0 // Placeholder to prevent overscroll calculations
        ...
        document.addEventListener(event, (event) => {
            ...
            if(newOpacity >= 0){
                if (event.type === "wheel"){
                    ...
                    deltaY += event.deltaY - overscrollDeltaY;
                } else if (event.type === "touchstart") {
                    initY = event.touches[0].pageY;
                } else if (event.type === 'touchmove') {
                    // Calculate delta for touch move
                    deltaY += (initY - (event.touches[0]?.pageY || initY)) - overscrollDeltaY;
                }
            }
